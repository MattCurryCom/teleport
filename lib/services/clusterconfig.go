...
type ClusterConfig interface {
	...
	GetDisconnecteExpiredCert() bool
...
// GetClientIdleTimeout returns client idle timeout setting
func (c *ClusterConfigV3) GetClientIdleTimeout() Duration {
	return c.Spec.ClientIdleTimeout
}

// SetClientIdleTimeout sets client idle timeout setting
func (c *ClusterConfigV3) SetClientIdleTimeout(d Duration) {
	c.Spec.ClientIdleTimeout = d
}

// GetDisconnectExpiredCert returns disconnect expired certificate setting
func (c *ClusterConfigV3) GetDisconnecteExpiredCert() Bool {
	return c.Spec.DisconnectExpiredCert
}

// SetDisconnectExpiredCert sets disconnect client with expired certificate setting
func (c *ClusterConfigV3) SetDisconnectExpiredCert(b Bool) {
	c.Spec.DisconnectExpiredCert = b
}
